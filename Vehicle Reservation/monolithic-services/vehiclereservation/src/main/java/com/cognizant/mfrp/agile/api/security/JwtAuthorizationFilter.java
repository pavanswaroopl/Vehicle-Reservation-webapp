package com.cognizant.mfrp.agile.api.security;
...
import com.cognizant.mfrp.agile.api.VehicleReservationApplication;
...
public class JwtAuthorizationFilter<Claims> extends BasicAuthenticationFilter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(VehicleReservationApplication.class);
